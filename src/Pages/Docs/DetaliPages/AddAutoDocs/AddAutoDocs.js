...
const AddAutoDocs = (
    ...
    useEffect(() => {
        dispatch('setTextHeader', 'добавить документы');
        ...
        const params = {
            url: '/api_get_cars/',
            page_id: state?.action_page_id ?? 4,
            type: 'brand',
            dataRequst: res => {
    ...
    }, [dispatch, tg.BackButton, navigate, state?.action_page_id, state?.old_name_button])
    ...
    const handlerSubmitChooseAggrigate = (data, { setFieldValue }) => {
        ...
        const params = {
            ...
            dataRequst: () => { },
            redirectTo: res => navigate('/button_docs', {
                state: {
                    ...state,
                                        ...
                                        >
                                            ...
                                            <Select
                                                ...
                                                onClick={e => {
                                                    ...
                                                    activeButtonBootomForConfirm(tg, values, null, 'Подтвердить')
                                                }
                                                }
                                            />
                                            <Offset mt={20} />
