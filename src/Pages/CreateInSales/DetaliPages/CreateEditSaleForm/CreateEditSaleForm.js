...
const CreateEditSaleForm = (
    ...
    useEffect(() => {
        ...
        tg.BackButton.onClick(() => navigate('/button_sales', {
            state: {
                name_button: state?.old_name_button ?? 'Продать'
            }
    ...
    const handlerSubmitChange = (data, { setFieldValue }) => {
        ...
        console.log('render function CreateEditSaleForm')
