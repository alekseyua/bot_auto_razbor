...
import style from './styles/createInParsing.module.scss';

const CreateInParsing = (
    ...
    const handlerChangeApplication = id => {
        navigate('/button_parsing/button_edit_parsing_form', {
            state: {
                application: id
            }
        })
    ...
    const handlerInCatalogApplication = id => {
        navigate('/button_parsing/button_edit_parsing', {
            state: {
                application: id
            }
        })
